...
# PURPOSE:     A brief description of what the program is supposed to accomplish.
# INPUT:       Data that must be collected by the program in order for it to run.
# PROCESS:     Actions performed on the data by the program to generate appropriate outputs.
